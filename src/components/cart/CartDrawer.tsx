                      ...
                      {items.map((item) => (
                        ...
                        >
                          <div className="relative w-[88px] h-[88px] bg-[#F8F8FA] rounded-xl shrink-0 overflow-hidden shadow-inner">
                            <Image src={item.product?.imageUrl || '/new-images/glow-and-nad-bg-image.webp'} alt={item.product?.name || 'Product'} fill className="object-cover hover:scale-105 transition-transform duration-500" />
                          </div>
