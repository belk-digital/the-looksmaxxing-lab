                ...
                <div className="flex flex-col flex-1 justify-between py-1 sm:py-0">
                  <div className="flex flex-col sm:flex-row justify-between items-start gap-2 sm:gap-4">
                    <div className="flex flex-col gap-1 sm:gap-1.5 pr-4 sm:pr-0">
                      <Link href={`/products/${item.product?.slug || item.productId}`} className={`text-base sm:text-xl md:text-2xl font-bold text-ink hover:text-[#5984c4] transition-colors leading-tight ${spaceGrotesk.className}`}>
                        {item.product?.name}
                      </Link>
