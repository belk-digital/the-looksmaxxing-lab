    ...
    <main className="bg-[#f3f4f6] min-h-screen">
      ...
      <section className="bg-ink text-white py-12">
        <div className="max-w-[1280px] mx-auto px-4 md:px-6">
          <StaggerChildren className="grid grid-cols-2 md:grid-cols-5 gap-6 text-center divide-x divide-gray-800">
            <motion.div variants={staggerItemVariants} className="px-4">
              <span className="block text-3xl font-black text-[#5984c4] mb-2">15%</span>
              <p className="text-sm text-gray-400">Commission on sales</p>
            </motion.div>
            <motion.div variants={staggerItemVariants} className="px-4 border-l-0 md:border-l">
              <span className="block text-3xl font-black text-[#5984c4] mb-2">15%</span>
              <p className="text-sm text-gray-400">Customer discount</p>
            </motion.div>
            <motion.div variants={staggerItemVariants} className="px-4">
              <span className="block text-3xl font-black text-[#5984c4] mb-2">7 Days</span>
              <p className="text-sm text-gray-400">Cookie duration</p>
            </motion.div>
            <motion.div variants={staggerItemVariants} className="px-4 border-l-0 md:border-l">
              <span className="block text-3xl font-black text-[#5984c4] mb-2">Real-time</span>
              <p className="text-sm text-gray-400">Commission tracking</p>
            </motion.div>
            <motion.div variants={staggerItemVariants} className="px-4 col-span-2 md:col-span-1 border-l-0 md:border-l pt-6 md:pt-0">
              <span className="block text-3xl font-black text-[#5984c4] mb-2">Monthly</span>
              <p className="text-sm text-gray-400">Reliable payouts</p>
            </motion.div>
          </StaggerChildren>
        </div>
      </section>
      ...
      <section className="px-4 md:px-6 py-12 max-w-[1280px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 bg-ink rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 text-white shadow-xl flex flex-col">
            <FadeUp>
              <h2 className="text-3xl lg:text-4xl font-bold mb-4 tracking-tight">Competitive Commission Structure</h2>
              <p className="text-gray-400 font-light mb-10 text-lg">Your commission is calculated on the full order value before discounts, maximizing your earning potential.</p>
                ...
                <div className="bg-white/5 p-6 rounded-2xl border border-white/10 flex flex-col h-full">
                  ...
                  <div className="space-y-4 text-sm flex-1">
                    <div className="flex justify-between items-center border-b border-white/10 pb-2">
                      <span className="text-gray-300">Customer Order Value</span>
                      <span className="font-bold">$200</span>
                    </div>
                    <div className="flex justify-between items-center border-b border-white/10 pb-2">
                      <span className="text-gray-300">Customer Discount (15%)</span>
                    ...
                    <div className="flex justify-between items-center pt-2">
                      <span className="text-white font-bold max-w-[120px]">Your Commission (15% of $200)</span>
                ...
                <div className="bg-white/5 p-6 rounded-2xl border border-white/10 flex flex-col h-full">
                  ...
                  <div className="space-y-4 flex-1">
                    <div className="flex justify-between items-center bg-black/20 p-3 rounded-lg">
                      <div>
                        <div className="font-bold text-white text-sm">10 referrals/mo</div>
                        <div className="text-[10px] text-gray-400 uppercase tracking-wider">@ $150 avg order</div>
                      </div>
                      <div className="font-black text-lg text-green-400">$225</div>
                    </div>
                    <div className="flex justify-between items-center bg-black/20 p-3 rounded-lg">
                      <div>
                        <div className="font-bold text-white text-sm">25 referrals/mo</div>
                        <div className="text-[10px] text-gray-400 uppercase tracking-wider">@ $150 avg order</div>
                      </div>
                      <div className="font-black text-lg text-green-400">$562.5</div>
                    </div>
                    <div className="flex justify-between items-center bg-black/20 p-3 rounded-lg border border-[#5984c4]/30">
                      <div>
                        <div className="font-bold text-white text-sm">50 referrals/mo</div>
                        <div className="text-[10px] text-gray-400 uppercase tracking-wider">@ $150 avg order</div>
                      </div>
                      <div className="font-black text-lg text-green-400">$1,125</div>
                    </div>
                  </div>
                </div>
              </div>
