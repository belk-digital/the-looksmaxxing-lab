...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Terms & Conditions',
    description: 'Terms and Conditions governing the purchase and use of research-use-only peptides from Longevia Research.',
    images: [{ url: '/og/og-home.webp', width: 1200, height: 630, alt: 'Longevia Research — Terms & Conditions' }],
    url: `${siteUrl}/terms`,
    type: 'website',
  },
}
      ...
      <section className="px-6 max-w-3xl mx-auto">
        <FadeUp>
          ...
          <p className="text-body-lg text-ink-muted leading-relaxed mb-16">
            Welcome to Longevia Research. By accessing this website, creating an account, or purchasing any product, you agree to be bound by the following Terms &amp; Conditions. If you do not agree to these terms, please do not use our website or place an order.
          </p>
          ...
          <div className="space-y-14 text-body-lg text-ink leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-ink-muted">
                ...
                <li>Longevia Research is not liable for shipping delays caused by the carrier once a package has left our facility.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-ink-muted">
                <li>No product sold by Longevia Research is approved for human or veterinary use.</li>
                ...
                <li>Longevia Research is not liable for any misuse, accidental exposure, or unapproved application of a purchased product.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-ink-muted">
                All website content — including product descriptions, Certificates of Analysis presentation, Journal articles, imagery, and branding — is the property of Longevia Research. Unauthorized reproduction, distribution, or commercial reuse of this content is prohibited.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-ink-muted">
                To the maximum extent permitted by law, Longevia Research is not liable for damages arising from product misuse, unauthorized application, or website errors, and any liability related to a specific order is limited to the purchase price of that order.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-ink-muted">
                You agree to indemnify and hold harmless Longevia Research, its employees, and affiliates from any claim, damage, or expense arising from your improper use of a product, violation of these Terms, or breach of any applicable law related to product use.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-ink-muted">
                These Terms are governed by the laws of the United States and the state in which Longevia Research operates. Any disputes arising from these Terms will be resolved under those laws.
              </p>
            </section>
